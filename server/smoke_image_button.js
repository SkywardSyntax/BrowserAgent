    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, tm.createTask('smoke image button', null)];
            case 1:
                taskId = _a.sent();
                return [4 /*yield*/, ba.initializeBrowser()];
            case 2:
                _a.sent();
                html = "<!doctype html><html><head><meta charset=\"utf-8\"><title>Image Button</title>\n  <style>\n    .wrap { display:inline-block; padding:6px; border:1px solid #ddd; cursor:pointer; }\n    img { width:64px; height:64px; }\n  </style>\n  </head><body>\n  <div id=\"status\">Not clicked</div>\n  <div class=\"wrap\" id=\"wrap\">\n    <img id=\"imgbtn\" alt=\"Play\" src=\"data:image/svg+xml,".concat(encodeURIComponent('<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"64\" height=\"64\"><polygon points=\"16,8 56,32 16,56\" fill=\"#2d6cdf\"/></svg>'), "\" />\n  </div>\n  <script>\n    document.getElementById('wrap').addEventListener('click', () => {\n      document.getElementById('status').textContent = 'Clicked!';\n    });\n  </script>\n  </body></html>");
                return [4 /*yield*/, ba.page.goto('data:text/html,' + encodeURIComponent(html), { waitUntil: 'domcontentloaded' })];
            case 3:
                _a.sent();
                return [4 /*yield*/, ba.executeBrowserAction(taskId, { action: 'click_image_like', alt: 'Play', reason: 'click image by alt' })];
            case 4:
                res = _a.sent();
            ...
            case 5:
                ...
                return [4 /*yield*/, ba.executeBrowserAction(taskId, { action: 'click_button_like', text: 'Play', reason: 'fallback button-like (unlikely to exist)' })];
            case 6:
            ...
            case 7:
                ...
                _a.label = 8;
            case 8:
                if (!(txt !== 'Clicked!')) return [3 /*break*/, 11];
                return [4 /*yield*/, ba.executeBrowserAction(taskId, { action: 'click_image_like', src: 'svg', reason: 'click image by src' })];
            case 9:
            ...
            case 10:
                ...
                _a.label = 11;
            case 11: return [4 /*yield*/, ba.cleanup()];
            case 12:
                _a.sent();
                return [2 /*return*/];
        }
